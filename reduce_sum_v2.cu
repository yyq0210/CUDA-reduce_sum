...
__global__ void reduce_sum(const T *d_in, T *d_out, size_t n) {
    ...
    size_t lane_id = tid % WARP_SIZE; // 获取线程在线程块中的位置
...
/*
Kernel execution time: 1.567840 ms
Sum: 499999080448.000000
CPU execution time: 2.185504 ms
